...
class GeneratePseudoAnomalyHook(Hook):
    ...
    def before_train(self, runner):
        ...
        interval = runner.dataloader.dataset.num_anomalies // word_size
        ...
        for idx in range(0, num_samples, 4):
            ...
            for i, (img, mask, contour) in enumerate(zip(imgs, masks, contours)):
                ...
                runner.dataloader.dataset.anomalies[rank * interval + idx + i] = \
    ...
    def before_train_epoch(self, runner):
        ...
        for i, (img, mask, contour) in enumerate(zip(imgs, masks, contours)):
            ...
            runner.dataloader.dataset.anomalies[replace_indices[i]] = {'image': torch.from_numpy(extracted_img).permute(2, 0, 1), \
                                                            'mask': torch.from_numpy(extracted_mask)}
